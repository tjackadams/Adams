...
namespace Nexus.WeightTracker
{
    ...
    public partial class WeightTrackerClient 
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Created> CreateClientMetricAsync(int clientId, CreateClientMetric_Data data, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (clientId == null)
                throw new System.ArgumentNullException("clientId");
